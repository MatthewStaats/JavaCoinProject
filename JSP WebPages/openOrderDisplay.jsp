...
<%-- 
     * openOrderDisplay jsp is ran from the Processor Page jsp Open Order Button
     * The form action calls procOpenOrders Servlet and displays the Order object's OrderList
     * This will show the logged in employee all OPEN orders from our Company's Database on this jsp
...
<html>
    ...
    <body>
        ...
        <h1 id="openHeader">TeamSix Coin Company<br/><br/>Open Orders for Processing<br/><br/></h1>  
        <%    
           Order ord;
           Order o2;
        ...
        <form action="openOrderDisplay.jsp">
            <div class="btn-block">
                <button type="submit" onclick="form.action ='orderUpdateServlet'; ">Approve Orders</button>
                <button type="submit" onclick ="window.history.go(-1); return false;">Back</button>
            </div>
        </form>
